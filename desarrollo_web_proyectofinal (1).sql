...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-12-2015 a las 17:04:29
...
(26, 'bPsqILeyvZ3bfuyLHg.mp4', 26, 'video'),
(27, 'wGymuzSWKaxkBfAoyI.jpeg', 28, 'image');
...
(25, 'Eric Zubin', 'f960acf2c49f5b5e9c22706d0f735020', 'eric', 'eric@eric.com'),
(26, '1234', 'ed2b1f468c5f915f3f1cf75d7068baae', '1234', '1234@1234.com'),
(28, 'prueba1', '2a0817c8b7dc2a4706f51b4c1965dbd9', 'prueba', 'pruebq!@ho.com');
...
--
ALTER TABLE `archivo`
  MODIFY `idArchivo` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=28;
--
